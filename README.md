...
| **k9s** | 0.31.2 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **termux-tools** | 1.40.5 | Basic system tools for Termux | https://termux.dev/ |
...
| **vale** | 3.0.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
