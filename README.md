...
| **nushell** | 0.89.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **vtm** | 0.9.54 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
